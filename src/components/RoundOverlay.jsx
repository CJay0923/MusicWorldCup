...
export default function RoundOverlay({ show, icon, title, sub, onContinue }) {
  return (
    ...
    >
      <div className="max-w-[420px] rounded-2xl border border-white/[0.08] bg-bg2 px-[50px] py-10 text-center shadow-[0_8px_32px_rgba(0,0,0,0.4)] animate-[pop_0.4s_cubic-bezier(0.22,1.3,0.36,1)]">

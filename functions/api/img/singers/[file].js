// Cloudflare Pages Function: 歌手头像代理（七牛 HTTP → 前端 HTTPS）
// GET /api/img/singers/:file  →  七牛 http://<QINIU_DOMAIN>/singers/:file
...
export async function onRequestGet(context) {
  ...
  try {
    const resp = await fetch(`${QINIU_HTTP_BASE}/singers/${file}`, {

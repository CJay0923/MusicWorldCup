// functions/_shared/text-utils.mjs
// 歌曲名归一化（去重 key）——前后端共用单一来源。纯函数，无 DOM / 无 Workers API。
//
// 与 filters.mjs 同理，放进 functions/_shared/ 以保证 Pages Functions 构建可靠打包；
// 前端经 src/utils/text.js 薄壳 re-export 复用 baseKey。
